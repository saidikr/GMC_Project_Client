...
export const Navbar2 = () => {
  ...
  return (
    ...
    <div className="flex container max-w-full mx-auto">
      ...
      <div className="flex-grow items-center" id="navbarNavDropdown">
        <ul className="flex flex-wrap list-reset pl-0 mb-0">
          ...
          <li >
            <Link className={Compare("/Cart", path.pathname)?"inline-block py-2 px-4 no-underline rounded-3xl text-white bg-nav-top":"inline-block py-2 px-4 no-underline hover:text-text"} to="Cart">Shpping Cart</Link>
          </li>
          <li >
