...
export const Offers = () => {
  return (
    <div className="sm:px-4 max-w-full offer mx-7 pt-5">
        <div className="flex flex-wrap justify-center items-center xl:px-12">
            <div className="md:w-1/2 pr-4 pl-4 pb-4">
                <div className="relative flex flex-col justify-center items-center md:flex-row bg-gray-200 text-center md:text-right text-white mb-2 py-5 px-5">
                    <img src={img1} height='280px' alt="imageimage"/>
                    <div className="mt-5 relative" >
                    <h5 className="uppercase text-site-color mb-3">30% off the all order</h5>
